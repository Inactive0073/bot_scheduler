...
class Customer(TimestampMixin,TelegramProfileMixin, Base):
    ...
    percent_cashback: Mapped[int] = mapped_column(SmallInteger, default=3, server_default=text("3"))
    visits_per_year: Mapped[int] = mapped_column(SmallInteger, default=0, server_default=text("0"))
    visits: Mapped[int] = mapped_column(SmallInteger, default=0, server_default=text("0"))