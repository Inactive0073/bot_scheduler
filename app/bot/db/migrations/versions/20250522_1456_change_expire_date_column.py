...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "uq_customers_telegram_id", "customers", ["telegram_id"]
    )
    op.create_unique_constraint(
        "uq_schedule_posts_schedule_id", "schedule_posts", ["schedule_id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "uq_schedule_posts_schedule_id", "schedule_posts", type_="unique"
    )
